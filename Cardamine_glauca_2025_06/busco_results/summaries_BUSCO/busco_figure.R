...
my_species <- c('BUSCO_Cardamine_glauca_CUNI_V1_2024_10_masked', 'BUSCO_Cardamine_glauca_CUNI_V1_2024_10_masked', 'BUSCO_Cardamine_glauca_CUNI_V1_2024_10_masked', 'BUSCO_Cardamine_glauca_CUNI_V1_2024_10_masked', 'BUSCO_braker_aa', 'BUSCO_braker_aa', 'BUSCO_braker_aa', 'BUSCO_braker_aa', 'BUSCO_Assembled_transcripts', 'BUSCO_Assembled_transcripts', 'BUSCO_Assembled_transcripts', 'BUSCO_Assembled_transcripts', 'BUSCO_braker_codingseq', 'BUSCO_braker_codingseq', 'BUSCO_braker_codingseq', 'BUSCO_braker_codingseq')
...
my_percentage <- c(94.2, 4.8, 0.2, 0.8, 83.9, 14.2, 0.1, 1.8, 58.3, 33.6, 1.3, 6.8, 83.9, 14.1, 0.2, 1.8)
my_values <- c(4329, 220, 9, 38, 3854, 652, 6, 84, 2679, 1543, 61, 313, 3857, 648, 7, 84)
