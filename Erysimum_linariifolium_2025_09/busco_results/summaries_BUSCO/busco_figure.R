...
my_species <- c('BUSCO_braker_aa', 'BUSCO_braker_aa', 'BUSCO_braker_aa', 'BUSCO_braker_aa', 'BUSCO_Erysimum_linariifolium_CUNI_V1_2024_09_masked', 'BUSCO_Erysimum_linariifolium_CUNI_V1_2024_09_masked', 'BUSCO_Erysimum_linariifolium_CUNI_V1_2024_09_masked', 'BUSCO_Erysimum_linariifolium_CUNI_V1_2024_09_masked', 'BUSCO_Assembled_transcripts', 'BUSCO_Assembled_transcripts', 'BUSCO_Assembled_transcripts', 'BUSCO_Assembled_transcripts', 'BUSCO_braker_codingseq', 'BUSCO_braker_codingseq', 'BUSCO_braker_codingseq', 'BUSCO_braker_codingseq')
...
my_percentage <- c(85.6, 12.9, 0.2, 1.3, 95.6, 4.2, 0.1, 0.1, 61.3, 29.5, 2.0, 7.2, 85.7, 12.8, 0.2, 1.3)
my_values <- c(3934, 594, 11, 57, 4394, 191, 5, 6, 2816, 1356, 92, 332, 3940, 588, 10, 58)
