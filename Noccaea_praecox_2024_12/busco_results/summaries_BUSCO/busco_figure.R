...
my_species <- c('BUSCO_braker_aa', 'BUSCO_braker_aa', 'BUSCO_braker_aa', 'BUSCO_braker_aa', 'BUSCO_Noccaea_polished_2024_10_Mahnaz', 'BUSCO_Noccaea_polished_2024_10_Mahnaz', 'BUSCO_Noccaea_polished_2024_10_Mahnaz', 'BUSCO_Noccaea_polished_2024_10_Mahnaz', 'BUSCO_Assembled_transcripts', 'BUSCO_Assembled_transcripts', 'BUSCO_Assembled_transcripts', 'BUSCO_Assembled_transcripts', 'BUSCO_braker_codingseq', 'BUSCO_braker_codingseq', 'BUSCO_braker_codingseq', 'BUSCO_braker_codingseq')
...
my_percentage <- c(82.4, 15.2, 0.3, 2.1, 94.4, 4.8, 0.2, 0.6, 55.9, 33.1, 3.0, 8.0, 82.6, 15.0, 0.3, 2.1)
my_values <- c(3787, 700, 12, 97, 4337, 221, 11, 27, 2567, 1523, 136, 370, 3796, 691, 12, 97)
