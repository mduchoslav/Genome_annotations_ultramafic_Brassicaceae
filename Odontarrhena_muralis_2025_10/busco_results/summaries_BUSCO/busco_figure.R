...
my_species <- c('BUSCO_braker_aa', 'BUSCO_braker_aa', 'BUSCO_braker_aa', 'BUSCO_braker_aa', 'BUSCO_Odontarrhena_muralis_CUNI_V1_2025_05_masked', 'BUSCO_Odontarrhena_muralis_CUNI_V1_2025_05_masked', 'BUSCO_Odontarrhena_muralis_CUNI_V1_2025_05_masked', 'BUSCO_Odontarrhena_muralis_CUNI_V1_2025_05_masked', 'BUSCO_Assembled_transcripts', 'BUSCO_Assembled_transcripts', 'BUSCO_Assembled_transcripts', 'BUSCO_Assembled_transcripts', 'BUSCO_braker_codingseq', 'BUSCO_braker_codingseq', 'BUSCO_braker_codingseq', 'BUSCO_braker_codingseq')
...
my_percentage <- c(82.6, 14.9, 0.2, 2.3, 93.9, 4.5, 0.2, 1.4, 56.8, 32.0, 2.0, 9.2, 82.5, 14.9, 0.2, 2.4)
my_values <- c(3795, 685, 7, 109, 4316, 208, 9, 63, 2612, 1471, 91, 422, 3793, 685, 8, 110)
