...
my_species <- c('BUSCO_braker_aa', 'BUSCO_braker_aa', 'BUSCO_braker_aa', 'BUSCO_braker_aa', 'BUSCO_Aethionema_saxatile_CUNI_V1_2025_05_masked', 'BUSCO_Aethionema_saxatile_CUNI_V1_2025_05_masked', 'BUSCO_Aethionema_saxatile_CUNI_V1_2025_05_masked', 'BUSCO_Aethionema_saxatile_CUNI_V1_2025_05_masked', 'BUSCO_Assembled_transcripts', 'BUSCO_Assembled_transcripts', 'BUSCO_Assembled_transcripts', 'BUSCO_Assembled_transcripts', 'BUSCO_braker_codingseq', 'BUSCO_braker_codingseq', 'BUSCO_braker_codingseq', 'BUSCO_braker_codingseq')
...
my_percentage <- c(80.5, 15.4, 0.3, 3.8, 93.0, 4.0, 0.3, 2.7, 50.8, 37.7, 1.5, 10.0, 80.6, 15.3, 0.3, 3.8)
my_values <- c(3699, 707, 13, 177, 4273, 186, 15, 122, 2337, 1734, 71, 454, 3703, 701, 14, 178)
